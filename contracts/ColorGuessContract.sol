...
contract ColorGuess is Game {
    ...
    function wager() override public payable{
        require(msg.sender.balance >= msg.value, "You must have enough funds to wager");
        require(msg.value > 0, "You must wager more than 0");
        require(players[msg.sender].hasBet == false, "You have already wagered and did not report you lost. Failure to do so results in not being able to play again!");
